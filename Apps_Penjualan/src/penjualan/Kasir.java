...
bsimpan.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void initComponents() {
        ...
        txtagama.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N

        txtalamat.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N

        txtpwd.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N

        rlaki.setFont(new java.awt.Font("Gill Sans MT", 2, 12)); // NOI18N
        rlaki.setText("Laki - Laki");

        rperempuan.setFont(new java.awt.Font("Gill Sans MT", 2, 12)); // NOI18N
        rperempuan.setText("Perempuan");

        bsimpan.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bsimpan.setText("Simpan");

        bubah.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bubah.setText("Ubah");

        bhapus.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bhapus.setText("Hapus");

        bbatal.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bbatal.setText("Batal");

        bkeluar.setBackground(new java.awt.Color(204, 0, 0));
        bkeluar.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bkeluar.setForeground(new java.awt.Color(255, 255, 255));
        bkeluar.setText("Keluar");

        tblkasir.setBackground(new java.awt.Color(153, 255, 255));
        tblkasir.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 0)));
        tblkasir.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        ...
        txtcari.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        ...
        bcari.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
        bcari.setText("Cari");

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 3, 12)); // NOI18N
        ...
        txtid.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N

        txttelp.setFont(new java.awt.Font("Gill Sans MT", 0, 12)); // NOI18N
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(txtnm, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        ...
                                        .addComponent(txtagama, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
